...
register_image_format(Format('left', _('Left-aligned'), 'richtext-image left', 'width-350'))
register_image_format(Format('right', _('Right-aligned'), 'richtext-image right', 'width-350'))
